...
package com.hzp.cocorunning.ui.ARMenu;
...
public class SampleAppMenuGroup
{
    ...
    private final WeakReference<SampleAppMenuInterface> mMenuInterface;
                              ...
                              int width)
    {
        ...
        mMenuInterface = new WeakReference<>(menuInterface);
        ...
        mClickListener = new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                mMenuInterface.get().menuProcess(command);
        ...
        mOnCheckedListener = new OnCheckedChangeListener()
        {
                ...
                boolean isChecked)
            {
                ...
                result = mMenuInterface.get().menuProcess(command);
                if (!result)
                {
