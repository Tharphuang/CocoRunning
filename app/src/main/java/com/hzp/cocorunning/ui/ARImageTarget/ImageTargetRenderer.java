...
package com.hzp.cocorunning.ui.ARImageTarget;
...
import com.hzp.cocorunning.util.ARUtils.SampleAppRenderer;
import com.hzp.cocorunning.util.ARUtils.SampleAppRendererControl;
import com.hzp.cocorunning.util.ARUtils.SampleApplicationSession;
import com.hzp.cocorunning.util.ARUtils.utils.CubeShaders;
import com.hzp.cocorunning.util.ARUtils.utils.LoadingDialogHandler;
import com.hzp.cocorunning.util.ARUtils.utils.MeshObject;
import com.hzp.cocorunning.util.ARUtils.utils.SampleApplication3DModel;
import com.hzp.cocorunning.util.ARUtils.utils.SampleMath;
import com.hzp.cocorunning.util.ARUtils.utils.SampleUtils;
import com.hzp.cocorunning.util.ARUtils.utils.Teapot;
import com.hzp.cocorunning.util.ARUtils.utils.Texture;
...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private void initRendering()
    {
        ...
        if(!mModelIsLoaded) {
            ...
            try {
                mmodel = new model(mActivityRef.get().getResources().getAssets());
